        ...
        <section class="error-page onepage-screen-area">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="content"  data-sal-duration="800" data-sal-delay="400">
                ...
                <div class="row row-cols-xl-4 row-cols-sm-2 row-cols-1 row--20">
                    <div class="col">
                        <div class="service-box service-style-2">
                            <div class="icon">
                                <img src="../../public/assets/images/icons/service1.png" alt="Service">
                            </div>
                            <div class="content">
                    ...
                    <div class="col">
                        <div class="service-box service-style-2">
                            <div class="icon">
                                <img src="../../public/assets/images/icons/service2.png" alt="Service">
                            </div>
                            <div class="content">
                    ...
                    <div class="col">
                        <div class="service-box service-style-2">
                            <div class="icon">
                                <img src="../../public/assets/images/icons/service3.png" alt="Service">
                            </div>
                            <div class="content">
                    ...
                    <div class="col">
                        <div class="service-box service-style-2">
                            <div class="icon">
                                <img src="../../public/assets/images/icons/service4.png" alt="Service">
                            </div>
                            <div class="content">
